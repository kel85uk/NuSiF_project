...
StaggeredGrid::StaggeredGrid (int xsize, int ysize, real delx, real dely):
					...
					f_(xsize+1,ysize+1), g_(xsize+1,ysize+1), rhs_(xsize+1,ysize+1),
...
StaggeredGrid::StaggeredGrid (GrayScaleImage image, real delx, real dely):
					...
					g_(image.width()+1,image.height()+1), rhs_(image.width()+1,image.height()+1),
...
StaggeredGrid::StaggeredGrid (const FileReader & config): 
                              ...
                              rhs_(config.getIntParameter("imax")+1 ,config.getIntParameter("jmax")+1),
